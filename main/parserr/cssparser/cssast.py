...
__all__ = ('Hexcolor', 'Function', 'Uri', 'String', 'Ident',
           'Term', 'Declaration', 'Directive', 'Ruleset', 'Charset', 'Page',
...
class Directive(SyntaxObject):
    def __init__(self, directive):
        self.directive = directive

    def __repr__(self):
        r = 'Directive(' + self.directive
        r += ')'
        return r
...
class Selector(SyntaxObject):
    ...
    Selector
    '''
    def __init__(self, simple_sels, important=False):
        self.simple_sels = simple_sels or list()

    def __repr__(self):
        r = 'Selector('
        r += repr(self.simple_sels)
        r += ')'
        return r
